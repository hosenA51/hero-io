        ...
        <div className='bg-[#F5F5F5]'>
            <div className='w-11/12 text-center space-y-6 pb-16 mx-auto'>
                ...
                <div className='flex justify-between mx-auto px-2'>
                    <h1 className='text-lg md:text-2xl font-semibold text-black'>({filteredApps.length}) Apps Found</h1>
                ...
                {filteredApps.length === 0 && (
                    <div className='space-y-5'>
                        ...
                        <h1 className='text-4xl font-bold text-black pt-12'>OPPS!! APP NOT FOUND</h1>
                        <p className='text-gray-500'>The App you are requesting is not found on our system.  please try another apps</p>
                        <NavLink to="/apps" onClick={() => setSearch("")} className="btn bg-linear-to-r from-[#6D28D9] to-[#8B5CF6] text-white w-28">Go Back</NavLink>
                    </div>
                )}
